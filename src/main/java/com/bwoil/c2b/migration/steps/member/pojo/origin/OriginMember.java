...
public class OriginMember {
    ...
    //开通云油账号时间
    private Integer yunAcctTime;

    // 身份证
    private byte[] idenCode;
    ...
    public byte[] getIdenCode() {
        return idenCode;
    }

    public void setIdenCode(byte[] idenCode) {
    ...
    public Integer getYunAcctTime() {
        return yunAcctTime;
    }

    public void setYunAcctTime(Integer yunAcctTime) {
